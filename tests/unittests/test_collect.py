...
class TestCollect(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user = self.users.first(username='guest')
        self.request = context.request = FakeRequest(
            '/myapp',
            user=self.user,
            site=FakeSite(db=self.db),
            path='/myapp',
        ...
        self.collection.store = self.collection.get_store(self.db)
    ...
    def test_insert(self):
        ...
        t = self.collect('new', **insert_record_input)
